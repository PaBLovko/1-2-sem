...
void inComputers(Computer** computers, unsigned size, char buffer[MAX_LENGHT], char buffer1[MAX_LENGHT])
{
	unsigned i;
	for (i = 0; i < size; i++)
	{
...
int main()
{
	...
	unsigned size=0;
	char buffer[MAX_LENGHT],buffer1[MAX_LENGHT], c;
	unsigned i;
	int j =0, k = 0, v = 0 ;
